...
namespace cv19ResSupportV3.V3.Factories
{
    ...
    {
        public static HelpRequest ToDomain(this HelpRequestEntityOld helpRequestEntityOld)
        {
            return new HelpRequest()
            {
                Id = helpRequestEntityOld.Id,
                IsOnBehalf = helpRequestEntityOld.IsOnBehalf,
                ConsentToCompleteOnBehalf = helpRequestEntityOld.ConsentToCompleteOnBehalf,
                OnBehalfFirstName = helpRequestEntityOld.OnBehalfFirstName,
                OnBehalfLastName = helpRequestEntityOld.OnBehalfLastName,
                OnBehalfEmailAddress = helpRequestEntityOld.OnBehalfEmailAddress,
                OnBehalfContactNumber = helpRequestEntityOld.OnBehalfContactNumber,
                RelationshipWithResident = helpRequestEntityOld.RelationshipWithResident,
                PostCode = helpRequestEntityOld.PostCode,
                Uprn = helpRequestEntityOld.Uprn,
                Ward = helpRequestEntityOld.Ward,
                AddressFirstLine = helpRequestEntityOld.AddressFirstLine,
                AddressSecondLine = helpRequestEntityOld.AddressSecondLine,
                AddressThirdLine = helpRequestEntityOld.AddressThirdLine,
                GettingInTouchReason = helpRequestEntityOld.GettingInTouchReason,
                HelpWithAccessingFood = helpRequestEntityOld.HelpWithAccessingFood,
                HelpWithAccessingSupermarketFood = helpRequestEntityOld.HelpWithAccessingSupermarketFood,
                HelpWithCompletingNssForm = helpRequestEntityOld.HelpWithCompletingNssForm,
                HelpWithShieldingGuidance = helpRequestEntityOld.HelpWithShieldingGuidance,
                HelpWithNoNeedsIdentified = helpRequestEntityOld.HelpWithNoNeedsIdentified,
                HelpWithAccessingMedicine = helpRequestEntityOld.HelpWithAccessingMedicine,
                HelpWithAccessingOtherEssentials = helpRequestEntityOld.HelpWithAccessingOtherEssentials,
                HelpWithDebtAndMoney = helpRequestEntityOld.HelpWithDebtAndMoney,
                HelpWithHealth = helpRequestEntityOld.HelpWithHealth,
                HelpWithMentalHealth = helpRequestEntityOld.HelpWithMentalHealth,
                HelpWithAccessingInternet = helpRequestEntityOld.HelpWithAccessingInternet,
                HelpWithHousing = helpRequestEntityOld.HelpWithHousing,
                HelpWithJobsOrTraining = helpRequestEntityOld.HelpWithJobsOrTraining,
                HelpWithChildrenAndSchools = helpRequestEntityOld.HelpWithChildrenAndSchools,
                HelpWithDisabilities = helpRequestEntityOld.HelpWithDisabilities,
                HelpWithSomethingElse = helpRequestEntityOld.HelpWithSomethingElse,
                MedicineDeliveryHelpNeeded = helpRequestEntityOld.MedicineDeliveryHelpNeeded,
                IsPharmacistAbleToDeliver = helpRequestEntityOld.IsPharmacistAbleToDeliver,
                WhenIsMedicinesDelivered = helpRequestEntityOld.WhenIsMedicinesDelivered,
                NameAddressPharmacist = helpRequestEntityOld.NameAddressPharmacist,
                UrgentEssentials = helpRequestEntityOld.UrgentEssentials,
                UrgentEssentialsAnythingElse = helpRequestEntityOld.UrgentEssentialsAnythingElse,
                CurrentSupport = helpRequestEntityOld.CurrentSupport,
                CurrentSupportFeedback = helpRequestEntityOld.CurrentSupportFeedback,
                FirstName = helpRequestEntityOld.FirstName,
                LastName = helpRequestEntityOld.LastName,
                DobMonth = helpRequestEntityOld.DobMonth,
                DobYear = helpRequestEntityOld.DobYear,
                DobDay = helpRequestEntityOld.DobDay,
                ContactTelephoneNumber = helpRequestEntityOld.ContactTelephoneNumber,
                ContactMobileNumber = helpRequestEntityOld.ContactMobileNumber,
                EmailAddress = helpRequestEntityOld.EmailAddress,
                GpSurgeryDetails = helpRequestEntityOld.GpSurgeryDetails,
                NumberOfChildrenUnder18 = helpRequestEntityOld.NumberOfChildrenUnder18,
                ConsentToShare = helpRequestEntityOld.ConsentToShare,
                DateTimeRecorded = helpRequestEntityOld.DateTimeRecorded,
                RecordStatus = helpRequestEntityOld.RecordStatus,
                CallbackRequired = helpRequestEntityOld.CallbackRequired,
                InitialCallbackCompleted = helpRequestEntityOld.InitialCallbackCompleted,
                CaseNotes = helpRequestEntityOld.CaseNotes,
                AdviceNotes = helpRequestEntityOld.AdviceNotes,
                HelpNeeded = helpRequestEntityOld.HelpNeeded,
                NhsNumber = helpRequestEntityOld.NhsNumber,
                NhsCtasId = helpRequestEntityOld.NhsCtasId,
                HelpRequestCalls = helpRequestEntityOld.HelpRequestCalls.ToDomain()
            };
        }
        ...
        public static HelpRequestEntityOld ToEntity(this HelpRequest helpRequest)
        {
